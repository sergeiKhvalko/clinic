...
try {
  ...
  $mail->Username   = 'falko.serega2016@yandex.ru'; // Логин на почте
  $mail->Password   = 'ztjgoamrvdkttida'; // Пароль на почте
  $mail->SMTPSecure = 'ssl';
  $mail->Port       = 465;

  $mail->setFrom('falko.serega2016@yandex.ru', 'Заявка с сайта'); // Адрес самой почты и имя отправителя
